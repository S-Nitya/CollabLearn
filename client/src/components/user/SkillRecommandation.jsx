...
import { Sparkles, BookOpen, Clock, Star, ArrowLeft, Zap, User } from 'lucide-react'; 
  ...
  return (
      ...
      <main className="pt-24 max-w-7xl mx-auto px-4">
        <div className="mb-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-900">Discover Skills</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {allSkills.map(card => (
            <div key={card.id} className="bg-white rounded-xl shadow p-4 border border-gray-200 transform transition-all duration-300 hover:scale-[1.03] hover:shadow-xl flex flex-col">
              {/* Main content area */}
              <div className="p-4 flex flex-col flex-grow">
                ...
                <div className="flex justify-between items-center mb-4">
                  ...
                  <div className="flex items-center gap-1 text-xs font-semibold bg-gray-100 text-gray-800 px-2 py-0.5 rounded-full">
                    <Zap className="w-3 h-3 text-gray-600"/>
                    <span>{card.matchScore}% Match</span>
                  </div>
                </div>

                {/* User Profile Section (Color changed to neutral gray) */}
                <div className="flex items-center gap-3 mb-4">
                  {/* CHANGED bg-indigo-500 to bg-gray-200 and text-white to text-gray-700 */}
                  <div className="w-10 h-10 rounded-full bg-gray-200 flex items-center justify-center text-xl shadow">
